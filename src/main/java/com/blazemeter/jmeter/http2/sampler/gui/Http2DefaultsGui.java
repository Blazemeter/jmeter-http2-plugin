...
public class Http2DefaultsGui extends AbstractConfigGui {
  ...
  public void configure(TestElement el) {
    ...
    embeddedResourceUrlRegexFilter.setText(
        http2Sampler.getPropertyAsString(HTTP2Request.EMBEDDED_URL_REGEX, ""));
    sourceIpAddr.setText(http2Sampler.getPropertyAsString(HTTP2Request.IP_SOURCE));
